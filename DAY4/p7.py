...
tomato_sales_2 = total_land/5.0*0.7
...
sun_sales=total_land/5.0*.7*1000 *200
sugarcane_sales=total_land/5.0*45*4000
total_sales=total_tomato_sales+potato_sales+cabbage_sales+sun_sales+sugarcane_sales
total_sales_2= total_sales-sugarcane_sales

print(f'total sales realization {total_sales}')
print(f'total sales in 2 is {total_sales_2}')
